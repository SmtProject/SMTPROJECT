...
public class SmtExportExcelSheetConfiguration<BEANTYPE> {

	/** parent export excel configuration **/
	private SmtExportExcelConfiguration<BEANTYPE> exportExcelConfiguration;
	...
	private List<SmtExportExcelComponentConfiguration<BEANTYPE>> componentConfigs = new ArrayList<>();
	...
	public SmtExportExcelConfiguration<BEANTYPE> getExportExcelConfiguration() {
		return this.exportExcelConfiguration;
	}

	public void setExportExcelConfiguration(SmtExportExcelConfiguration<BEANTYPE> exportExcelConfiguration) {
	 ...
	 */
	public List<SmtExportExcelComponentConfiguration<BEANTYPE>> getComponentConfigs() {
	 ...
	 */
	public void setComponentConfigs(final List<SmtExportExcelComponentConfiguration<BEANTYPE>> componentConfigs) {
