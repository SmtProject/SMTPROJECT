 ...
 * @author k.suba
 */
public class SmtBooleanColumnFormatter implements SmtColumnFormatter {
	 ...
	 *            the false value
	 */
	public SmtBooleanColumnFormatter(final String truePlaceholder, final String falsePlaceholder) {
