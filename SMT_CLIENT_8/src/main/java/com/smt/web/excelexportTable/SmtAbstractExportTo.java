 ...
 * @author Kartik Suba
 */
public abstract class SmtAbstractExportTo {

	/** The Constant LOGGER. */
	protected static final Logger LOGGER = Logger.getLogger(SmtAbstractExportTo.class.getName());

	protected final String mimeType;

	public SmtAbstractExportTo(String mimeType) {
